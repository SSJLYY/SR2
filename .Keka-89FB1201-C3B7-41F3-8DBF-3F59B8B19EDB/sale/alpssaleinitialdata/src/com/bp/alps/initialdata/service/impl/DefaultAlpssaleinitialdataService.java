...
public class DefaultAlpssaleinitialdataService implements AlpssaleinitialdataService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAlpssaleinitialdataService.class);
	...
	{
		return DefaultAlpssaleinitialdataService.class.getResourceAsStream("/alpssaleinitialdata/sap-hybris-platform.png");
	}
