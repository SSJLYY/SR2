 ...
 */
package com.dp.alps.storefront.controllers.misc;
...
import com.dp.alps.storefront.controllers.ControllerConstants;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "alpssalestorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("alpssalestorefront.quick.order.rows.max", 25);
