...
import com.dp.webservices.data.UserDataList;
import com.dp.webservices.dto.SampleWsDTO;
import com.dp.webservices.dto.TestMapWsDTO;
import com.dp.webservices.dto.UserWsDTO;
import com.dp.webservices.dto.UsersListWsDTO;
import com.dp.webservices.facades.SampleFacades;
import com.dp.webservices.initializer.TestBean;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/alpssalewebservices/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/alpssalewebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/alpssalewebservices/sample/users
	 * <li>http://localhost:9001/alpssalewebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/alpssalewebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/alpssalewebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/alpssalewebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/alpssalewebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	...
	@ResponseBody
	public List<UserData> getUsers2(@RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		final List<UserData> users = sampleFacades.getUsers();
		return users;
	}
	...
	@ResponseBody
	public UserData getUsers3(@RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		final List<UserData> users = sampleFacades.getUsers();
		return users.get(0);
	}
	 ...
	 * <ul>
	 * <li>http://localhost:9001/alpssalewebservices/sample/users/user1
	 * <li>http://localhost:9001/alpssalewebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/alpssalewebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/alpssalewebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/alpssalewebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/alpssalewebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/alpssalewebservices/sample/map
	 *
	 */
