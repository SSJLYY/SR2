...
public class DefaultAlpsaftersalecoreService implements AlpsaftersalecoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAlpsaftersalecoreService.class);
	...
	{
		return DefaultAlpsaftersalecoreService.class.getResourceAsStream("/alpsaftersalecore/sap-hybris-platform.png");
	}
