...
import com.bp.alps.after.sale.core.enums.PickupInStoreWorkOrderStatus;
...
public class PickupInStoreInputUpdatePopulator  implements Populator<PickupInStoreData,PickupInStoreModel> {
    @Resource
