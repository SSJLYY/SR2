...
public class IncrementOrderBaseOutputPopulator implements Populator<IncrementOrderModel, IncrementOrderBaseData>
{
    @Resource
    ...
    @Override
    public void populate(IncrementOrderModel source, IncrementOrderBaseData target) throws ConversionException
    {
