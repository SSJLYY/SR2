...
public class DefaultAlpsaftersaleinitialdataService implements AlpsaftersaleinitialdataService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAlpsaftersaleinitialdataService.class);
	...
	{
		return DefaultAlpsaftersaleinitialdataService.class.getResourceAsStream("/alpsaftersaleinitialdata/sap-hybris-platform.png");
	}
