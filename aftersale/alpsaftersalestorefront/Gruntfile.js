module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
        ...
        ybasejs: {
            files: ['web/webroot/WEB-INF/_ui-src/responsive/lib/alps-0.1.0/js/**/*.js'],
            tasks: ['sync:syncybase'],
        },
        ybaseimage: {
            files: ['web/webroot/WEB-INF/_ui-src/responsive/lib/ybase-0.1.0/images/**'],
            tasks: ['sync:syncyimagesbase'],
        },
        jquery: {
    ...
    sync : {
    	...
    	syncybase: {
    		files: [{
    			cwd: 'web/webroot/WEB-INF/_ui-src/responsive/lib/alps-0.1.0/js/',
    			src: '**/*.js',
