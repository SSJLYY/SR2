...
<template:errorSpanField path="${path}" notIncludeWrap="${notIncludeWrap}" wrapCSS="${wrapCSS}">
	<ycommerce:testId code="LoginPage_Item_${idKey}">
			<label class="word_spac ${fn:escapeXml(labelCSS)}" for="${escapedIdKey}">
			...
			<form:select id="${escapedIdKey}" path="${escapedPath}" cssClass="form-control hell ${fn:escapeXml(selectCSSClass)}" tabindex="${fn:escapeXml(tabindex)}" disabled="${disabled}">
