...
<c:url value="/increment-order/user/delete" var="deleteUrl"/>
...
<div class="row ls_nav">
    <div class="table-responsive pick_car_list">
        <table class="table  pick_carTable2 pick_carTable_even">
            ...
            <tbody>
            <c:forEach items="${incrementOrderData.relatedRole}" var="user" varStatus="status">
                <tr>
...
<c:url value="/increment-order/user/create" var="registerActionUrl" />
