            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 Ry_flex form-group col_p">
                        ...
                        <input id="entry-discount-rate" name="products.discountRate" disabled="disabled" class="input_number form-control" type="text" value="100"><label for="" class="label_color input_company">%</label>
                        <label for="entry-actual-price" class="label_color"><spring:theme code='entry.actual.price' /></label>
                        <input id="entry-actual-price" name="products.actualPrice" disabled="disabled" class="input_number form-control" type="text" value="">
