    ...
    <form:form id="service-order-update" method="post" commandName="serviceOrderData" action="${action}">
        <div class="row row_left row_right">
            <div class="col-md-4 col-sm-4 Ry_flex form-group com_first col_p2">
                <label class="word_spac"><spring:theme code="detail.service.order.timeFee" /> ${serviceOrderData.timeFee}</label>
            </div>
        </div>
        <div class="row row_left row_right">
            <div class="col-md-4 col-sm-4 Ry_flex form-group col_p2">
                <label class="word_spac"><spring:theme code="detail.service.order.accessoriesFee" /> ${serviceOrderData.accessoriesFee}</label>
            </div>
        </div>
        <div class="row row_left row_right">
            <div class="col-md-4 col-sm-4 Ry_flex form-group col_p2">
                <label class="word_spac"><spring:theme code="detail.service.order.otherFee" /> ${serviceOrderData.otherFee}</label>
            </div>
        </div>
        <div class="row row_left row_right">
            <div class="col-md-4 col-sm-4 Ry_flex form-group col_p2">
                <label class="word_spac"><spring:theme code="detail.service.order.manageFee" /> ${serviceOrderData.manageFee}</label>
            </div>
        </div>
        <div class="row row_left row_right">
            <div class="col-md-4 col-sm-4 Ry_flex form-group col_p2">
                <label class="word_spac"><spring:theme code="detail.service.order.subTotal" /> ${serviceOrderData.subTotal}</label>
            </div>
        </div>
        <div class="row row_left row_right">
            <div class="col-md-4 col-sm-4 Ry_flex form-group col_p2">
                <label class="word_spac"><spring:theme code="detail.service.order.total" /> ${serviceOrderData.total}</label>
            </div>
        </div>
    </form:form>
</div>
