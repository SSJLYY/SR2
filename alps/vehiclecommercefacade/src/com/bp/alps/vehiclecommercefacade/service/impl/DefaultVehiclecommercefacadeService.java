...
public class DefaultVehiclecommercefacadeService implements VehiclecommercefacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultVehiclecommercefacadeService.class);
	...
	{
		return DefaultVehiclecommercefacadeService.class.getResourceAsStream("/vehiclecommercefacade/sap-hybris-platform.png");
	}
