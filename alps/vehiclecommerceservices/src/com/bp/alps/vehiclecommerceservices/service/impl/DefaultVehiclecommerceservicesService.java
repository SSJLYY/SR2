...
public class DefaultVehiclecommerceservicesService implements VehiclecommerceservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultVehiclecommerceservicesService.class);
	...
	{
		return DefaultVehiclecommerceservicesService.class.getResourceAsStream("/vehiclecommerceservices/sap-hybris-platform.png");
	}
