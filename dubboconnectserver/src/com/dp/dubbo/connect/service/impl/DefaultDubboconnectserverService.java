...
public class DefaultDubboconnectserverService implements DubboconnectserverService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDubboconnectserverService.class);
	...
	{
		return DefaultDubboconnectserverService.class.getResourceAsStream("/dubboconnectserver/sap-hybris-platform.png");
	}
