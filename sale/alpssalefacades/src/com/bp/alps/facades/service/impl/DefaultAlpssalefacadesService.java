...
public class DefaultAlpssalefacadesService implements AlpssalefacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAlpssalefacadesService.class);
	...
	{
		return DefaultAlpssalefacadesService.class.getResourceAsStream("/alpssalefacades/sap-hybris-platform.png");
	}
