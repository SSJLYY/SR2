 ...
 */
package com.bp.alps.fulfilmentprocess.test;
...
import com.bp.alps.fulfilmentprocess.constants.AlpssalefulfilmentprocessConstants;
import com.bp.alps.fulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from alpssalefulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/alpssalefulfilmentprocess/test/alpssalefulfilmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "alpssalefulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "alpssalefulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "alpssalefulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/alpssalefulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/alpssalefulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = AlpssalefulfilmentprocessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				AlpssalefulfilmentprocessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				AlpssalefulfilmentprocessConstants.ORDER_PROCESS_NAME);
