 ...
 */
package com.bp.alps.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AlpssalefulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AlpssalefulfilmentprocessConstants.PARENT_PROCESS);
