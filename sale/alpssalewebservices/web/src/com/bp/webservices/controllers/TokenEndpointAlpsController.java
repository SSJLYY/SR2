...
public class TokenEndpointAlpsController extends AbstractEndpoint
{
	...
	public ResponseEntity<OAuthAccessTokenData> postAccessMyToken(Principal principal, @RequestParam Map<String, String> parameters) throws Exception {
		ResponseEntity<OAuthAccessTokenData> responseEntity = null;
		if (!(principal instanceof Authentication)) {
			...
			if (clientId != null && !clientId.equals("") && !clientId.equals(tokenRequest.getClientId())) {
				...
				if (!StringUtils.hasText(tokenRequest.getGrantType())) {
					...
					if(org.apache.commons.lang3.StringUtils.isBlank(mytoken.getToken())){
						String message = messageSource.getMessage(mytoken.getMessageCode(), null,i18nService.getCurrentLocale());
